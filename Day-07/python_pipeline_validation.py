# -*- coding: utf-8 -*-
"""python_pipeline_validation.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1fHh8rqPtygMwmvqXhBrmIqcpByfaPXId
...
!pip install -q pytest hypothesis pytest-cov
...
def normalize_amount(df):
    ...
    return df.assign(
        amount_z=((df["amount"] - mu) / sigma).round(4)
    )
...
class TestNormalizeAmount:
    ...
    def test_z_score_mean_zero(self):
        ...
        assert abs(result["amount_z"].mean()) < 0.01
    ...
    def test_z_score_std_one(self):
        ...
        assert abs(result["amount_z"].std() - 1) < 0.05
...
def test_tier_always_present(amounts):
...
print("test_pipeline.py created")
...
# =========================================================
# EXTENSION C — PROMETHEUS METRICS
# COLAB READY
# =========================================================
...
def run_pipeline_metrics():
    ...
    try:
        ...
        with timed_stage("validate"):
            ...
            ROWS_VALID.inc(len(valid_df))

            VALIDATION_ERRORS.inc(errors)

            QUALITY_PASS_RATE.set(
                len(valid_df) / len(df)
            )
