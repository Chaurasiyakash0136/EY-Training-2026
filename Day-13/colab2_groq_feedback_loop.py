...
Original file is located at
    https://colab.research.google.com/drive/12JWSTzGp9tcLzWlBpGRWT84vDy5SAbg3
...
print("="*80)
print("DAY 13 REFLECTION QUESTIONS")
print("="*80)

print("\n1. Which failure category had the highest business impact?")

print("""
Hallucinations have the highest business impact because
incorrect financial figures may lead to poor lending
decisions, financial losses, and regulatory issues.
""")

print("\n2. Does a longer prompt increase cost?")

print("""
Yes. Longer prompts consume more tokens which can increase
LLM inference cost. However, improved prompt quality often
reduces manual review effort and improves reliability.
""")

print("\n3. Was the additional prompt complexity worth it?")

print("""
Yes. The structured v2.0 prompt improved consistency,
reduced hallucinations, and produced more reliable
credit memos.
""")
...
print("\n5. What would be your next experiment?")

print("""
• Retrieval-Augmented Generation (RAG)
• Few-shot prompting
• Structured JSON outputs
• Additional prompt versions
...
!pip install -q langsmith langchain langchain-core langchain-groq
print("✅ LangSmith packages installed")
...
os.environ["LANGCHAIN_TRACING_V2"] = "true"
os.environ["LANGCHAIN_API_KEY"] = userdata.get("LANGCHAIN_API_KEY")
os.environ["LANGCHAIN_PROJECT"] = "Day13-FinSight-Groq"
...
print("API Key:", bool(os.environ.get("LANGCHAIN_API_KEY")))
...
def traced_credit_memo(prompt_cfg, borrower_data):
    ...
    messages = [
        ...
        (
            "human",
            prompt_cfg["user_template"].format(
                data=borrower_data
            )
        )
    ]
...
print("✅ LangSmith traced function ready")

print("Generating LangSmith traces...\n")

for prompt_cfg in [PROMPT_V1_0, PROMPT_V2_0]:

    print(f"Running {prompt_cfg['version']}")

    result = traced_credit_memo(
        prompt_cfg,
        BORROWER_PROFILES[0]
    )
...
print("✅ LangSmith traces generated")